...
function FooterMenu() {
  return (
    <nav className="w-full h-auto flex justify-center sm:justify-start fixed bottom-0 mb-0 bg-gradient-to-t from-black-theme via-black-theme sm:from-transparent pt-5 sm:mb-10 sm:max-w-screen-xl sm:pt-0 sm:px-4 xl:px-0 ">
      <Link href="/projects">
