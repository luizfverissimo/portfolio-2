...
function FooterMenu() {
  return (
    <nav className="w-full h-auto flex justify-center sm:justify-start fixed bottom-0 mb-0 bg-black-theme pt-4 sm:mb-20 sm:max-w-screen-xl sm:bg-transparent sm:pt-0 sm:px-4 xl:px-0 ">
      <Link href="/projects">
